...
public class ScrollBarUI extends BasicScrollBarUI {
  ...
  protected void configureScrollBarColors() {
      ...
      trackColor = Index.BACKGROUND_EYESHIELD;
  ...
  public void paintTrack(Graphics g, JComponent c, Rectangle trackBounds) {
      ...
      if (this.scrollbar.getOrientation() == JScrollBar.VERTICAL) {
          ...
          gp = new GradientPaint(0, 0, Index.BACKGROUND_EYESHIELD, trackBounds.width, 0, Index.BACKGROUND_EYESHIELD);

      }

      if (this.scrollbar.getOrientation() == JScrollBar.HORIZONTAL) {

          gp = new GradientPaint(0, 0, Index.BACKGROUND_EYESHIELD, trackBounds.height, 0, Index.BACKGROUND_EYESHIELD);
